...
<div class="breadcrumb-header justify-content-between">
	<div class="my-auto">
		<div class="d-flex">
			<h4 class="content-title mb-0 my-auto">الفواتير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ ارشفه الفواتير</span>
		</div>
	</div>
									...
									<div class="dropdown">
										...
										<div class="dropdown-menu tx-13">
											...
											<a class="dropdown-item" href="#" data-invoice_id="{{ $invoice->id }}" data-toggle="modal" data-target="#Transfer_invoice">
												<i class="text-warning fas fa-exchange-alt"></i>&nbsp;&nbsp;نقل الي الفواتير
											</a>
		...
		<div class="modal-content modal-content-demo">
			...
			<div class="modal-body">
				<div class="row">
					...
					<form method="post" action="invoicesArchive">
						{{csrf_field()}}
						<div class="form-group">

							<span>هل انت متاكد من الغاء ارشفه الفاتوره؟</span>
				...
				<div class="row">
					...
					<form method="post" action="invoicesArchive">
						...
						<div class="form-group">
							...
							<span>هل انت متاكد من حذف الفاتوره؟</span>
