...
@section('title')
الصفحه الرئيسيه برنامج الفواتير
@stop
@section('css')
<!--  Owl-carousel css-->
...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div>
						  <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">الصفحه الرئيسيه برنامج الفواتير
</h2>
						</div>
					</div>
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-up text-white">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7"> 	{{(App\Models\invoices::where('value_status',2)->count() / App\Models\invoices::count())*100}}%
</span>
										</span>
									</div>
								</div>
							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
											<span class="text-white op-7"> 	{{(App\Models\invoices::where('value_status',1)->count() / App\Models\invoices::count())*100}}%
</span>
										</span>
									</div>
								</div>
							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
											<span class="text-white op-7"> 	{{(App\Models\invoices::where('value_status',3)->count() / App\Models\invoices::count())*100}}%
</span>
										</span>
									</div>
								</div>
